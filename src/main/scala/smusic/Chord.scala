...
object ChordClass {
  val TriadMajor = ChordClass(Intervals(4, 3, 5))
  val TriadMinor = ChordClass(Intervals(3, 4, 5))
  val TetradMajor7 = ChordClass(Intervals(4, 3, 4, 1))
  val TetradMinor7 = ChordClass(Intervals(3, 4, 3, 2))
  val Tetrad7 = ChordClass(Intervals(4, 3, 3, 2))
}
